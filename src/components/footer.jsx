...
export function FooterWithSitemap() {
    return (
        <footer className="relative mt-10 bg-customBlue w-full">
            <div className="mx-auto w-full max-w-7xl px-8">
                <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-4">
                    <div className="flex flex-col pr-5">
                        <span className=" text-white font-sofadi font-bold text-xl">Vitaléa</span>
                        <span className="pt-3 text-gray-200 font-normal">Helping you stay on top of your wellness journey with ease and confidence.</span>
                    </div>
                ...
                <div className="flex w-full flex-col items-center justify-center border-t border-white-50 py-4 md:flex-row md:justify-between">
                    ...
                    >
                        &copy; {currentYear} <a href="https://material-tailwind.com/">Vitalea</a>. All
                        Rights Reserved.
                    </Typography>
